...
| Search-Console figures quoted in deliverables (impressions/clicks/CTR/mobile share) | **بيانات حساب حقيقي — لا تُعرض ولا تُنقل** | `deliverables/title-meta-optimization.md` سطر 2؛ قاعدة التكليف (4) |
